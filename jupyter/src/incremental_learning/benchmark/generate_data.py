...
from incremental_learning.config import data_dir
...
def import_real_data(keyword=None, balanced=True, path_to_dir=data_dir, max_num_samples=None, regression=False, categorical=False, dim=[],
                     rng=None):
